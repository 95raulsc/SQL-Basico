...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HR"."EQUIPOS_PK" ON "HR"."EQUIPOS" ("EQUIPOS_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."AFICION" MODIFY ("EQUIPO" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."EQUIPOS" ADD CONSTRAINT "EQUIPOS_PK" PRIMARY KEY ("EQUIPOS_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."EQUIPOS" MODIFY ("EQUIPOS_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."AFICION" ADD CONSTRAINT "EQUIPO_FK" FOREIGN KEY ("AFICION_ID")
	  REFERENCES "HR"."EQUIPOS" ("EQUIPOS_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CANTICOS
--------------------------------------------------------

  ALTER TABLE "HR"."CANTICOS" ADD CONSTRAINT "AFICION_FK" FOREIGN KEY ("CANTICOS_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."EQUIPOS" ADD CONSTRAINT "AFICION_FK1" FOREIGN KEY ("AFICION_ID")
	  REFERENCES "HR"."AFICION" ("AFICION_ID") ENABLE;
  ALTER TABLE "HR"."EQUIPOS" ADD CONSTRAINT "ESTADIO_FK1" FOREIGN KEY ("ESTADIO_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."JUGADORES" ADD CONSTRAINT "EQUIPOS_FK1" FOREIGN KEY ("JUGADORES_ID")
	  REFERENCES "HR"."EQUIPOS" ("EQUIPOS_ID") ENABLE;
--------------------------------------------------------
